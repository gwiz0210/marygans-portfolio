...
<figure style="margin: 0; text-align: center;">
  <div style="border-radius:4px; overflow:hidden; aspect-ratio:16/8.4;">
    <img src="/images/ai-dashboard/entra-landing-screenshot.png" alt="Dashboard concept mockup" style="width:100%; height:100%; display:block; object-fit:cover; object-position:center 0%;" />
  </div>
  <figcaption style="margin-top:0.5rem; color:#64748b; font-weight:600;">Dashboard concept mockup / screenshot</figcaption>
</figure>
...
<ul>
<li>Influenced the AI strategy for Entra Admin</li>
<li>Created reusable AI recommendation patterns</li>
<li>Shipped designs used across multiple AI experiences</li>
<li>Informed executive direction</li>
</ul>
...
<figure style="margin: 0; text-align: center;">
  <div style="border-radius:4px; overflow:hidden; aspect-ratio:16/8.4;">
    <img src="/images/ai-dashboard/ai-dashboard-scrolling.gif" alt="Dashboard landing" style="width:100%; height:100%; display:block; object-fit:cover; object-position:center 0%;" />
  </div>
...
<figure style="margin: 0; text-align: center;">
  <div style="border-radius:4px; overflow:hidden; aspect-ratio:16/8.4;">
    <img src="/images/ai-dashboard/ai-dashboard-loading.gif" alt="Prototype interaction / motion preview" style="width:100%; height:100%; display:block; object-fit:cover; object-position:center 0%;" />
  </div>
